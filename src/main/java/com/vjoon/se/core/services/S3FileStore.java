...
public class S3FileStore implements FileStore {
    ...
    public void save(String nameSpace, String key, InputStream stream, Optional<String> checksum, boolean overwrite) {
        ...
        Map<String, Object> headers =
                ImmutableMap.of("CamelFileName", createFileNameFromID(nameSpace, key), "Checksum", checksum.get());
    ...
    public String getHash(String nameSpace, String key) {
        return getMetaData(nameSpace, key).orElseThrow(() -> new FileStoreException("Could not find s3 Object"))
                .getETag();
    }
