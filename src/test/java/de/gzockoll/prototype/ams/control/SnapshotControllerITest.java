...
public class SnapshotControllerITest {
    ...
    public void testRestore() throws IOException {
        ...
        Assertions.assertThat(assetController.findAll()).hasSize(1);
        uploadFile(f1,"junit2");
        Assertions.assertThat(assetController.findAll()).hasSize(2);
        uploadFile(f2,"junit2");
        Assertions.assertThat(assetController.findAll()).hasSize(3);
    }
